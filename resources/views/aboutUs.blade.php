        ...
        <div class="container">
            <div class="block">
                ...
                <div class="content">
                    ...
                    <ul>
                        <li>O Doubt oferece uma seção dedicada a fornecer indicações de livros, documentações e recursos de estudo relevantes para os temas abordados no curso. Isso auxilia os alunos a aprofundarem seus conhecimentos. </li>
                    </ul>
                </div>  
                <div class="content">
                    <h2>Fórum de Dúvidas:</h2>
                    <ul>
                        <li>Uma plataforma interativa que possibilita que alunos e professores interajam em um fórum dedicado a esclarecer dúvidas e discutir tópicos relacionados ao curso. Essa ferramenta promove a colaboração e a resolução coletiva de questões acadêmicas. </li>
                    </ul>
                </div>  
                <div class="content">
                    <h2>Fórum de Dúvidas:</h2>
                ...
                <div class="content">
                    ...
                    <ul>
                        <li>O sistema unifica informações essenciais, permitindo que os alunos acessem facilmente detalhes das aulas, datas de monitoria e recursos de estudo em um só lugar.</li>
                    </ul>
                </div>    
                <div class="content">
                    <h2>Orientação no Estudo:</h2>
                    <ul>
                        <li>Os alunos podem planejar seu aprendizado de forma mais eficaz, sabendo antecipadamente quais tópicos serão abordados e quais recursos são recomendados.</li>
                    </ul>
                </div>        
                <div class="content">
                    <h2>Interação Significativa:</h2>
                    <ul>
                        <li>Fórum de dúvidas promove uma comunidade interativa em que alunos e professores podem colaborar para esclarecer questionamentos e compartilhar conhecimentos.</li>
                    </ul>
                </div>  
                <div class="content">
                    <h2>Economia de Tempo:</h2>
                    <ul>
                        <li>Ao concentrar informações relevantes e recursos de estudo em uma plataforma, o sistema economiza o tempo dos alunos na busca por informações dispersas.</li>
                    </ul>
                </div>   
                <div class="content">
                    <h2>Aprimoramento da Experiência Educacional:</h2>
                    <ul>
                        <li>Através do acesso a informações organizadas e ferramentas de interação, o sistema contribui para uma experiência de aprendizado mais rica e eficiente.</li>
                    </ul>
                </div> 
                <div class="content">
                    <p>O Doubt visa preencher uma lacuna importante na jornada de aprendizado, oferecendo uma solução unificada e acessível para facilitar o estudo e solucionar dúvidas.  </p>
                </div>                
            </div>
        </div>
