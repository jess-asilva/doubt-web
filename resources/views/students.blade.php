        ...
        <div class="container">
            <div class="row">
                ...
                <form action="{{ route('delete.user', $student->id)}}" method="post">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="button-arquive" id="submit"><svg xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="row2">
                <button class="button" id="submit"><a
                        href="{{ route('change-role', ['userId' => $student->id, 'role' => 'Monitor']) }}">TORNAR
                        MONITOR</a></button>
            </div>
            <div class="row">
