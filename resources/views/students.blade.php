        ...
        <div class="container">
            <div class="row">
                <div class="row2">
                    ...
                    <!-- <button class="button" id="submit">ARQUIVAR</button> -->
                </div>
            </div>
            <div class="row2">
                <button class="button"><a href="{{ route('delete.student', $student->id)}}">ARQUIVAR</a></button>
                <button class="button"><a href="{{ route('delete.student', $student->id)}}">TORNAR MONITOR</a></button>
            </div>
